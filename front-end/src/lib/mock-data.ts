...
export const FILES_BY_COLLECTION: Record<string, CollectionFile[]> = {
  research: [
    ...
    {
      id: "3",
      name: "LLM Evaluation Methods.pdf",
      size: "2.1 MB",
      pages: 28,
    ...
    {
      id: "4",
      name: "Vector Databases Overview.pdf",
      size: "0.9 MB",
      pages: 11,
  ...
  work: [
    ...
    {
      id: "9",
      name: "Incident Report Apr 12.pdf",
      size: "0.3 MB",
      pages: 5,
  ...
  books: [
    ...
    {
      id: "19",
      name: "The Design of Everyday Things.pdf",
      size: "2.8 MB",
      pages: 368,
